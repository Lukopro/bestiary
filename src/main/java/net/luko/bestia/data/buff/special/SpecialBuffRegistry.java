...
public class SpecialBuffRegistry {
    ...
    public static final SpecialBuff<Float> EXECUTE =
            register(new FloatBuff(ResourceLocation.fromNamespaceAndPath(Bestia.MODID, "execute"), 0.0F, 0.1F, 3));
    public static final SpecialBuff<Float> LIFESTEAL =
            register(new FloatBuff(ResourceLocation.fromNamespaceAndPath(Bestia.MODID, "lifesteal"), 0.0F, 0.05F, 5));
